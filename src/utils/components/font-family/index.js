...
function FontFamilyPicker( { label, value, help, instanceId, onChange, className, ...props } ) {
	...
	const id = `inspector-rblock-font-family-${ instanceId }`;
	 ...
	 * @type {Array}
	 */
	fonts = wp.hooks.applyFilters( 'rblock.google_fonts', fonts );
	...
	const onChangeValue = ( event ) => {
		...
		if ( typeof meta !== 'undefined' && typeof meta._rblock_fonts_attr !== 'undefined' ) {
			ba = meta._rblock_fonts_attr;
		}
	...
	return (
		<BaseControl label={ label } id={ id } help={ help } className={ className }>
			...
			<select
				id={ id }
				className="components-select-control__input components-select-control__input--rblock-fontfamily"
